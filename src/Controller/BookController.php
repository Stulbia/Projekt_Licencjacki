...
class BookController extends AbstractController
{
    ...
    #[Route('/search', name: 'book_search', methods: 'GET')]
    public function search(#[MapQueryString(resolver: BookSearchInputFiltersDtoResolver::class)] BookSearchInputFiltersDto $filters, #[MapQueryParameter] int $page = 1): Response
    {
        $form = $this->createForm(SearchBookType::class, [
            'action' => $this->generateUrl('book_search'),
        ]);
